"""
This does work but the concatenated genome one does not :/ new download.py script adds a location curation tool
"""
...
def main(db_path, fasta_file, metadata_file, headers, filters, segments, complete_genomes, header_delimiter, curate_locations):
...
if __name__ == "__main__":
    ...
    main(args.db, args.fasta, args.metadata, args.headers, filters, segments, args.complete_genomes, args.header_delimiter, args.curate_locations)
